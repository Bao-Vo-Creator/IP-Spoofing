...
void got_packet(u_char *args, const struct pcap_pkthdr *header, const u_char *packet){
	...
	iph->ip_src.s_addr = inet_addr (inet_ntoa(ip->ip_dst));/* SYN's can be blindly spoofed */
...
int main(int argc, char **argv)
{
	...
	char filter_exp[] = "icmp[icmptype] == icmp-echo and icmp[icmptype] != icmp-echoreply";		/* filter expression [3] */
